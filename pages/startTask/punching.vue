	...
	<view class="mian_background main_content">
		<self-start-task :detail="detail">
			<view slot="task">
				...
				<self-input label="饲料厂" v-model="coms"></self-input>
				<self-input label="下料地点" v-model="address"></self-input>
			</view>
			<view slot="car">
				<self-input label="车辆类型" value="饲料车" disabled></self-input>
