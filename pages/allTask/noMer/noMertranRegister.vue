	...
	<view class="mian_background main_content">
		<self-task-box :detail="detail">
			<view slot="basic">
				...
				<self-input label="出发地" value="前花园" disabled></self-input>
				<self-input label="车牌号" value="浙A123" disabled></self-input>
				<self-input label="目的地" value="浙前花园" disabled></self-input>
			</view>
			<view slot="task">
