<template>
	...
	<view class="mian_background main_content">
		<self-task-box :detail="detail">
			<view slot="task">
				<self-input label="种源地" value="前湖区" disabled></self-input>
				<self-input label="计划时间" value="2020-01-02" disabled></self-input>
			</view>
			
			<view class="self_task_basic">车辆资源</view>
			<self-input label="车牌类别" value="引种车" disabled></self-input>
			<self-input label="车牌号" value="浙A 123" disabled></self-input>
			
			<view class="self_task_basic self_user">装箱记录</view>
			<self-input label="实际装猪数" value="100"></self-input>
