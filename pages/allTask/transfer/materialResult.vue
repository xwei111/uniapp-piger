	...
	<view class="mian_background main_content">
		<self-task-box :detail="detail">
			<view slot="basic">
				...
				<self-input label="采样地点" value="中转站" disabled></self-input>
				<self-input label="采样日期" value="2020-01-02" disabled></self-input>
				<self-input label="记录人" value="张三" disabled></self-input>
			</view>
			<view slot="task">
