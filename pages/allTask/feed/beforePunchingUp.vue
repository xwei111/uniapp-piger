<template>
	...
	<view class="mian_background main_content">
		<self-task-box :detail="detail">
			<view slot="basic">
				<self-input label="车牌号" value="折A 123" disabled></self-input>
				<self-input label="驾驶员" value="小白" disabled></self-input>
			</view>
			<view slot="task">
				<self-upLoad label="打料前饲料车铅封完整照片" @changeHandle="changeHandle"></self-upLoad>
				<self-upLoad label="下料口末端确定包裹了塑料照片" @changeHandle="changeHandle"></self-upLoad>
			</view>
		</self-task-box>
