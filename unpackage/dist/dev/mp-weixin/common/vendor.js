...
/***/ 11:
/*!****************************************!*\
  !*** D:/progress/piger/store/index.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 428));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    switchModal: function switchModal(state, color) {
      if (color) {
        uni.hideTabBar();
      } else {
        uni.showTabBar();
...
/***/ 321:
/*!*****************************************!*\
  !*** D:/progress/piger/utils/consts.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.tasktype = void 0;var tasktype = {
  car: { ig: '/static/img3.png', color: '#0FBB87' }, // 车辆洗消
  region: { ig: '/static/img4.png', color: '#FF8D67' }, // 区域任务
  piger: { ig: '/static/img5.png', color: '#FEA0D6' }, // 猪只任务
  feed: { ig: '/static/img6.png', color: '#FEBA59' }, // 饲料任务
  material: { ig: '/static/img7.png', color: '#88BFFE' }, // 物资任务
  food: { ig: '/static/img8.png', color: '#C09DFF' }, // 食材任务
  fertilizer: { ig: '/static/img9.png', color: '#BBA887' } // 粪肥任务
...
/***/ 46:
/*!**************************************!*\
  !*** D:/progress/piger/utils/ver.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.verSfz = exports.verTell = void 0; // 电话
var verTell = function verTell(value) {
  var reg = /^1[3456789]\d{9}$/;
  return reg.test(value);
};
// 身份证
exports.verTell = verTell;var verSfz = function verSfz(value) {
  var reg = /^[1-9]\d{5}(18|19|20|(3\d))\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/;
  return reg.test(value);
};exports.verSfz = verSfz;

/***/ }),

/***/ 63:
/*!*****************************************************!*\
  !*** D:/progress/piger/components/timer/GetDate.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
